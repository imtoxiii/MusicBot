...
async def start_pm(client, message: Message, _):
    ...
    # Register the bot instance when a user starts the bot
    bot_id = app.me.id
    ...
    if len(message.text.split()) > 1:
        ...
        try:
            out = private_panel(_)
            lol = await message.reply_text("𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 𝗖ᴜᴛᴇ ✘ 𝗠𝗨𝗦𝗜𝗖 𝗕𝗢𝗧 {} ❣️".format(message.from_user.mention))
            await lol.edit_text("𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 𝗖ᴜᴛᴇ ✘ 𝗠𝗨𝗦𝗜𝗖 𝗕𝗢𝗧 {} 🥳".format(message.from_user.mention))
            await lol.edit_text("𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 𝗖ᴜᴛᴇ ✘ 𝗠𝗨𝗦𝗜𝗖 𝗕𝗢𝗧 {} 💥".format(message.from_user.mention))
            await lol.edit_text("𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 𝗖ᴜᴛᴇ ✘ 𝗠𝗨𝗦𝗜𝗖 𝗕𝗢𝗧 {} 🤩".format(message.from_user.mention))
            await lol.edit_text("𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 𝗖ᴜᴛᴇ ✘ 𝗠𝗨𝗦𝗜𝗖 𝗕𝗢𝗧 {} 💌".format(message.from_user.mention))
            await lol.edit_text("𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 𝗖ᴜᴛᴇ ✘ 𝗠𝗨𝗦𝗜𝗖 𝗕𝗢𝗧 {} 💞".format(message.from_user.mention))
    ...
    for member in message.new_chat_members:
        try:
            ...
            if member.id == app.id:
                ...
                # Register the bot being added to a new chat
                bot_id = app.me.id
                owner_id = config.OWNER_ID
                chat_id = message.chat.id
                system_manager.register_bot(bot_id, owner_id, chat_id)
